...
class PilImageTest(test.BaseTest):
    def test_not_image(self):
        ...
        """
        self.assertRaises(IOError, source_generators.pil_image, BytesIO(b'not an image'))
    ...
    def test_exif_orientation(self):
        ...
        for exif_orientation, data in EXIF_ORIENTATION.items():
            ...
            self.assertTrue(
                ...
                f'EXIF orientation {exif_orientation} did not match reference image',
            )
